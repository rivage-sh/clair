from example_2_database.derived.user_order_stats import (
    trouve as example_2_database_derived_user_order_stats,
)
...
trouve = Trouve(
    ...
    sql=f"""
        ...
        cross join p10
        where s.lifetime_value <= p10.threshold
        order by s.lifetime_value asc
    """,
    columns=[
