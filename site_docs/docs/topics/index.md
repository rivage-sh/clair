...
four pages before you use clair. Read the others when you need the behaviour. Read the last
page, The Anatomy of a Run, at the end: it shows how each subject above operates in one
`clair run`.
